...
# setwd("D:/UNI/01_Master/3. Semester/Consulting")
...
tweepy_df <- read_delim('./input/tweepy_df.csv', delim = ',')
...
# save
saveRDS(topic, "./output/topic.rds")
...
# load data
topic <- readRDS("./output/topic.rds")
...
write.csv(colnames_user, file = "./topic_colnames.csv")
write.csv(colnames_user_monthly, file = "./topic_monthly_colnames.csv")

# save
saveRDS(alldata_user, "./output/prep.rds")
saveRDS(alldata_user_monthly, "./output/prep_monthly.rds")

# reload and split into train and test set (50-50 split)

set.seed(123)
alldata_user <- readRDS("./output/prep.rds")
p <- 0.5
...
saveRDS(alldata_user_train, "./output/prep_train.rds")
saveRDS(alldata_user_test, "./output/prep_test.rds")

set.seed(123)
alldata_user_monthly <- readRDS("./output/prep_monthly.rds")
p <- 0.5
...
saveRDS(alldata_user_monthly_train, "./output/prep_monthly_train.rds")
saveRDS(alldata_user_monthly_test, "./output/prep_monthly_test.rds")
