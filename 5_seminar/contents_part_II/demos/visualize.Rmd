...
This demo is about **visualizing results of sentiment classifcation**.
...
dfm <- quanteda::dfm(
  quanteda::corpus(data_labeled, text_field = "twitter_full_text"),
  remove = quanteda::stopwords("de"),
  remove_punct = TRUE,
  groups = "label") %>%
