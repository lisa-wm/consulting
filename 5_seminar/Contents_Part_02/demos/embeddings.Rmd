...
test_tokens <- tokenize(twitter_corpus)
test_tokens[1:2]
...
test_model <- fit_glove(test_vocab, skip_grams_window = 5, dimension = 3, x_max = 5)
test_model
...
get_glove_embeddings <- function(tokens, glove, iterations, convergence_tol, threads) {
