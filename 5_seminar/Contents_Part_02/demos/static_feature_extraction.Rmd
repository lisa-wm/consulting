...
There is still a variety of tokens we could probably remove.
...
list_gpc <- readRDS("5_seminar/global_polarity_clues.RDS")

list(head(list_gpc$positive), head(list_gpc$negative))
...
saveRDS(twitter_features_static, "5_seminar/twitter_features_static.RDS")
