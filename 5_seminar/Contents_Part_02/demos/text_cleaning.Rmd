...
path <- "2_code/1_data/1_training_data/emojis_unicode.csv"
...
twitter_data[, full_text := lapply(
  .I, 
  function(i) {
    components <- unlist(stringr::str_split(full_text[i], " ")) # split text into single tokens
