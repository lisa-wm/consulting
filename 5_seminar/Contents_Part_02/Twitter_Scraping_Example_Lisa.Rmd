...
We need to set up our API token prior to executing the following code.
Note that you need to define your personal `consumer_key`, `consumer_secret`, `access_token`, and `access_secret`.
