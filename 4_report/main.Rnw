...
\label{project}
\input{chapters/project.Rnw}

\section{Theoretical Background}
\label{theory}
\input{chapters/theory.Rnw}

\section{Data}
\label{data}
\input{chapters/data.Rnw}

\section{Part I: Topic-Specific Sentiment Analysis in \texttt{R}}
\label{rpipeline}
\input{chapters/rpipeline.Rnw}

\section{Part II: Topic-Specific Sentiment Analysis with \texttt{BERT}}
\label{bert}
\input{chapters/bert.Rnw}
