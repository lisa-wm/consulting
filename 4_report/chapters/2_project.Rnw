...
\begin{enumerate}
  \item The first approach applies standard machine learning tools which require 
  ...
  (section \ref{data_preproc} will address the challenges arising from Twitter 
  data in more detail).
