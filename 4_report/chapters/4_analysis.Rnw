...
The STM is a generative topic model and attempts to recreate the very process 
that generated the observed documents.
...
As opposed to the original LDA approach, the STM offers the possibility to 
incorporate document-level meta data. 
