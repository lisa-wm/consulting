...
It also includes the corpus of training data we have manually annotated.
The material is composed as an online course, largely following the 
...
The \texttt{R} block contains three sub-chapters.
