...
results.
These include, among others, using the STM for topic modeling (with a particular 
topical prevalence formula and the simplification of pooling tweets into 
pseudo-documents), our choice of learning algorithms, and the 
