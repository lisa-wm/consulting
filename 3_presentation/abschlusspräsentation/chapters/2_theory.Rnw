...
\end{center}
\caption{\raggedright Topic modeling and sentiment analysis. \textit{Source:} 
adopted and modified from \citet{minpark2016}.}
\end{figure}
...
\end{center}
\caption{\raggedright Taxonomy of topic models. \textit{Source:} own 
representation.}
\end{figure}
...
\end{center}
\caption{\raggedright Schematic process of generative topic modeling. 
...
\begin{itemize}
  ...
  \begin{itemize}
    \item \textbf{Standard ML:} random forests \& regularized logistic 
    regression
    \item \textbf{BERT:} fine-tuning to sentiment analysis
  \end{itemize}  
\end{itemize}
