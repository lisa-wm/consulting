% ------------------------------------------------------------------------------
% SLIDES FOR NLP COLLOQUIUM ON 2020-11-27
% ------------------------------------------------------------------------------ 
...
\setbeamercolor{palette primary}{bg = gray!90,fg = white}
\setbeamercolor{structure}{fg = gray!90} % itemize, enumerate, etc
\setbeamercolor{alerted text}{fg = gray!90}
...
\usepackage{Sweave}
\begin{document}
\input{20201127_nlp_colloqium-concordance}
